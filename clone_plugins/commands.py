...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 𝐌𝐲 𝐭𝐞𝐥𝐞𝐠𝐫𝐚𝐦 𝐜𝐡𝐚𝐧𝐧𝐞𝐥  ', url='https://t.me/Damboyisowner')
            ],[
    ...
    if not files_:
        ...
        try:
            ...
            title = '@Damboy94  ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
            ...
            await msg.delete()
            await k.edit_text("<b>Your File/Video is successfully deleted!!! you want again [Get Here](https://https://t.me/Damboyisowner) </b>")
